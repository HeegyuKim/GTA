...
def construct_generation_args():
    ...
    parser.add_argument("--gate-model", type=str, default='no')
    
    parser.add_argument("--embedding_checkpoint", type=str, default="models/DisCup/detoxic/distill_tuning_positive_(5,5).ckpt")
    parser.add_argument("--task_name", type=str, default="detoxic",choices = ["detoxic","sentiment"])
    ...
    parser.add_argument("--template", type=str, default="(5,5)")
    ...
    parser.add_argument("--ranking_scope", type=int, default=10)
    ...
    parser.add_argument("--tuning_name", type=str, default="distill_tuning", choices=["prompt_tuning","disc_tuning","distill_tuning"])
    ...
    args.device = "cuda:0" # torch.device("cuda" if torch.cuda.is_available() and not args.no_cuda else "cpu")
