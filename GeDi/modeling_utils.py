...
class PreTrainedModel(nn.Module, ModuleUtilsMixin, GenerationMixin, PushToHubMixin):
    ...
    def _classify_text(self, tokenizer, classifier, texts, gate_threshold=0.5):
        ...
        outputs = (outputs > gate_threshold).float()
    ...
    def _generate_no_beam_search(
        ...
        rewards=None
        initial_input_ids_len = input_ids.shape[1]
        ...
        while cur_len < max_length:
            ...
            if classifier_model is not None and gedi_model is not None:
                ...
                generated_text = tokenizer.batch_decode(test_input_ids[:, initial_input_ids_len:], skip_special_tokens=True)
                # print(generated_text)
                toxicity = self._classify_text(classifier_tokenizer, classifier_model, generated_text, gate_threshold)
